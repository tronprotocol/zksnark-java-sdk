...
public class LibsodiumTest
{
    ...
    {
        byte[] cipherNonce = new byte[crypto_aead_chacha20poly1305_IETF_NPUBBYTES];
        byte[] kEnc = HexBin.decode("cf9961c91dcea84ffdd0ce54ae2d86f815c988275701b47585d64dbf2b1b11ee");
        ...
        instance.cryptoAeadChacha20Poly1305IetfEncrypt(ciphertext, null, message, ZC_ENCPLAINTEXT_SIZE, null, 0, null, cipherNonce, kEnc);
