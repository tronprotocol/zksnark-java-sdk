...
public class LibrustzcashTest
{
    ...
    private static final long[] LONG_ARRAY = {-9223372036854775808L, 0L, 9223372036854775807L};
    ...
    public void librustzcashSaplingComputeNfTest()
    {
        ...
        for (long val : LONG_ARRAY) {
            ...
            Assert.assertArrayEquals(HexBin.decode(BYTE_32_EMPTY), result1);
        }
    }
    ...
    public void librustzcashComputeCm()
    {
        ...
        byte[] pkD = HexBin.decode("20001646fe036e09506e844a4acc668793a964cde6da3d5e2fd5f92c36546ba3");
        long value = 40;
        byte[] r = HexBin.decode("c7cd0ca6ad3c27cbea38e94575f221d0037d9076c4cf64cb37e9a72d657ad401");
        byte[] result = new byte[32];
        boolean ret = LibrustzcashWrapper.getInstance()
                .librustzcashSaplingComputeCm(diversifier, pkD, value, r, result);
        Assert.assertFalse(ret);
        ...
        boolean ret2 = LibrustzcashWrapper.getInstance()
                .librustzcashSaplingComputeCm(diversifier, pkD2, value, r, result);
